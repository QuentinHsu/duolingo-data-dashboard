 ...
 */
export async function getDuolingoUserInfo(user_id: z.infer<typeof UserSchema.shape.user_id>, cookie: z.infer<typeof UserSchema.shape.cookie>): Promise<z.infer<typeof UserSchema>> {
